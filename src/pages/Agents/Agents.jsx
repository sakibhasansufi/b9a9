        ...
        <div className="grid md:grid-cols-2 lg:flex gap-5 mt-16 mb-8 md:max-w-7xl md:mx-auto">
            <div className="mx-auto space-y-6 rounded-2xl bg-slate-100/70 px-4 py-2 shadow-md dark:bg-[#18181B] md:w-[350px]">
                ...
                <div className="mt-5  items-center justify-between">
                    <h2 className="font-medium text-gray-700 md:text-sm dark:text-white/60">Email : alanborder@alpshome.com</h2>
                    <h2 className="font-medium text-gray-700 md:text-sm dark:text-white/60">Phone : 949-655-0517</h2>
            ...
            <div className="max-[350px] mx-auto space-y-6 rounded-2xl bg-slate-100/70 px-6 py-4 shadow-md dark:bg-[#18181B] md:w-[350px]">
                ...
                {/* Price and action button */}
                <div className="mt-5  items-center justify-between">
                    <h2 className="font-medium text-gray-700 md:text-sm dark:text-white/60">Email : phoebe@alpshome.com</h2>
                    <h2 className="font-medium text-gray-700 md:text-sm dark:text-white/60">Phone : 949-555-1517</h2>
            ...
            <div className="max-[350px] mx-auto space-y-6 rounded-2xl bg-slate-100/70 px-6 py-4 shadow-md dark:bg-[#18181B] md:w-[350px]">
                ...
                {/* Price and action button */}
                <div className="mt-5  items-center justify-between">
                    <h2 className="font-medium text-gray-700 md:text-sm dark:text-white/60">Email : tyron@alpshome.com</h2>
                    <h2 className="font-medium text-gray-700 md:text-sm dark:text-white/60">Phone : 949-185-0617</h2>
            ...
            <div className="max-[350px] mx-auto space-y-6 rounded-2xl bg-slate-100/70 px-6 py-4 shadow-md dark:bg-[#18181B] md:w-[350px]">
                ...
                {/* Price and action button */}
                <div className="mt-5  items-center justify-between">
                    <h2 className="font-medium text-gray-700 md:text-sm dark:text-white/60">Email : angelina@alpshome.com</h2>
                    <h2 className="font-medium text-gray-700 md:text-sm dark:text-white/60">Phone : 948-755-0617</h2>
